...
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:oai="http://www.openarchives.org/OAI/2.0/" xmlns:rights="http://www.openarchives.org/OAI/2.0/rights/" version="1.0">
...
<html>
  ...
  <body>
     <h1>
                    <a href="http://www.hab.de">
                        <img src="http://www.hab.de/images/logo_start.gif" height="25" alt="" border="0"/>
                    </a>
                    <xsl:text>   </xsl:text>OAI 2.0 Request Results - <a href="http://www.hab.de/bibliothek/wdb/">Wolfenbuettel Digital Library</a>
                </h1>
    ...
    <p class="intro">An XSLT file has converted the <a href="http://www.openarchives.org">OAI-PMH 2.0</a> responses into XHTML which looks nice in a browser which supports XSLT such as Mozilla, Firebird and Internet Explorer. The XSLT file was created by <a href="http://www.ecs.soton.ac.uk/people/cjg">Christopher Gutteridge</a> at the University of Southampton as part of the <a href="http://software.eprints.org">GNU EPrints system</a>, and is freely redistributable under the <a href="http://www.gnu.org">GPL</a>. It was slightly adapted for the Wolfenbuettel Digital Libary.</p>
                ...
                <p class="intro">For more information or to download the XSL file please see the <a href="http://software.eprints.org/xslt.php">OAI to XHTML XSLT homepage</a>. The Wolfenbuettel version containing minor changes can be downloaded <a href="oai2.xsl">here</a>.</p>
...
<xsl:template name="quicklinks">
    <ul class="quicklinks">
      ...
      <li>
                <a href="?verb=ListRecords&amp;metadataPrefix=oai_dc">ListRecords</a> | </li>
      <li>
...
<xsl:template match="oai:ListMetadataFormats">
  <xsl:choose>
    <xsl:when test="$identifier">
      <p>This is a list of metadata formats available for the record "<xsl:value-of select="$identifier"/>". Use these links to view the metadata: <xsl:apply-templates select="oai:metadataFormat/oai:metadataPrefix"/>
                </p>
    </xsl:when>
    <xsl:otherwise>
...
<xsl:template match="node()" mode="xmlMarkup">
  <div class="xmlBlock">
    &lt;<span class="xmlTagName">
            ...
            <xsl:apply-templates select="@*" mode="xmlMarkup"/>&gt;<xsl:apply-templates select="node()" mode="xmlMarkup"/>&lt;/<span class="xmlTagName">
                <xsl:value-of select="name(.)"/>
            </span>&gt;
  </div>
</xsl:template>
